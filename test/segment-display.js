  ...
  switch (mask) {
    ...
    case '*':
      ...
      if (this.segmentCount == 16) {
        ...
        if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x01);
        context.beginPath();
        switch (this.cornerType) {
          case SegmentDisplay.SymmetricCorner:
            context.moveTo(x + s + d, y + s);
      ...
      if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x02);
      context.beginPath();
      switch (this.cornerType) {
        case SegmentDisplay.SymmetricCorner:
      ...
      if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x04);
      context.beginPath();
      ...
      if (this.segmentCount == 16) {
        ...
        if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x08);
        context.beginPath();
        context.moveTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
        switch (this.cornerType) {
      ...
      if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x10);
      context.beginPath();
      context.moveTo(x, y + this.segmentWidth + d);
      context.lineTo(x + s, y + s + d);
      context.lineTo(x + this.segmentWidth, y + this.segmentWidth + d);
      ...
      if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x20);
      context.beginPath();
      ...
      if (this.segmentCount == 7) {
        ...
        if (mask=='*') context.fillStyle = this.getSegmentColorAsterisk(c,0x40);
        context.beginPath();
        context.moveTo(x + s + d, y + s);
        context.lineTo(x + this.segmentWidth + d, y);
        context.lineTo(x + this.digitWidth - this.segmentWidth - d, y);
...
SegmentDisplay.prototype.getSegmentColorAsterisk = function(c,m) {
  var cv=c.charCodeAt(0);
  console.log("c="+c+"cv="+cv+" m="+m);
  return (cv & m) ? this.colorOn : this.colorOff;
} 
